...
####
   **1. 문서작성**  
&nbsp;&nbsp;&nbsp;1) 모의고사 파트 연결 클래스와 전송방식 작성  
&nbsp;&nbsp;&nbsp;2) 모의고사 파트 DB 기초 table 작성  
&nbsp;&nbsp;&nbsp;3) 모의고사 파트 사용할 논리적, 물리적 DB 구현  
&nbsp;&nbsp;&nbsp;4) 모의고사 파트 사용할 Table 상세 데이터 입력  
&nbsp;&nbsp;&nbsp;5) 모의고사 파트 프로세스 흐름도를 도표로 표현  
&nbsp;&nbsp;&nbsp;6) 모의고사 프로세스 흐름도를 도표로 표현  
&nbsp;&nbsp;&nbsp;7) 모의고사 파트 서비스별 기능 작성  
&nbsp;&nbsp;&nbsp;8) 모의고사 파트 각 테이블의 컬럼 정보 정리 및 작성  
&nbsp;&nbsp;&nbsp;9) 모의고사 파트 공통된 네이밍 규칙 정리  
&nbsp;&nbsp;&nbsp;10) 모의고사 파트 화면 설계서 작성  
&nbsp;&nbsp;&nbsp;11) 모의고사 파트 화면 경로 작성  
&nbsp;&nbsp;&nbsp;12) 모의고사 파트 클래스 경로 작성  
&nbsp;&nbsp;&nbsp;13) 모의고사 만들기 파트 화면구현  

   **2. 모의고사 목록 파트 화면구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 모의고사 목록 파트 디자인구현  
&nbsp;&nbsp;&nbsp;2) 모의고사 목록 파트 조건별 검색 구현  
&nbsp;&nbsp;&nbsp;3) 모의고사 목록 파트 시험정보 자세히보기 디자인 및 DB연동구현  
&nbsp;&nbsp;&nbsp;4) 모의고사 목록 관리자가 등록한 시험목록 표기 구현  

   **3. 모의고사 응시 파트 화면 구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 모의고사 응시 메인부분 시험정보 표기/과목선택 구현  
&nbsp;&nbsp;&nbsp;2) 모의고사 응시 부분 응시파트 / 시험결과 부분 구현  
&nbsp;&nbsp;&nbsp;3) 모의고사 응시 해설부분 문제별 채점결과 및 해설표기 구현  

   **4. 모의고사 응시목록 파트 응시목록 디자인 구현**  
&nbsp;&nbsp;&nbsp;1) 모의고사 응시목록 파트 응시목록 디자인 구현  



   **5. 모의고사 응시목록 파트 응시 모의고사 상세성적 디자인 구현**  
&nbsp;&nbsp;&nbsp;1) 모의고사 응시목록 파트 응시 모의고사 상세성적 디자인 구현  

   **6. 관리자페이지 전반적 디자인 구현**  
&nbsp;&nbsp;&nbsp;1) 관리자페이지 전반적 디자인 구현  

   **7. 문제카테고리파트 디자인 및 기능 구현**  
&nbsp;&nbsp;&nbsp;1) 문제은행에서 문제를 분류할 분류 기준 추가/수정 기능 구현  

   **8. 문제은행 파트 화면 구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 문제은행 파트 디자인구현  
&nbsp;&nbsp;&nbsp;2) 문제은행 파트 조건별 검색 구현  
&nbsp;&nbsp;&nbsp;3) 문제은행 파트 문제 미리보기 디자인 및 DB연동 구현  
&nbsp;&nbsp;&nbsp;4) 문제은행 파트 문제목록 문제 상태변경 구현  
&nbsp;&nbsp;&nbsp;5) 문제은행 파트 문제등록 페이지 디자인 및 등록기능 구현  
&nbsp;&nbsp;&nbsp;6) 문제은행 파트 문제수정 페이지 디자인 및 수정기능 구현  

   **9. 시험관리 파트 화면구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 시험관리 파트 디자인구현  
&nbsp;&nbsp;&nbsp;2) 시험관리 파트 조건별 검색 구현  
&nbsp;&nbsp;&nbsp;3) 시험관리 파트 시험등록 페이지 디자인 및 등록기능 구현  
&nbsp;&nbsp;&nbsp;4) 시험관리 파트 시험수정 페이지 디자인 및 수정기능 구현  

   **10. 문제구성관리 파트 화면구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 문제구성관리 파트 모의고사 선택부분 기능구현  
&nbsp;&nbsp;&nbsp;2) 문제구성관리 파트 과목별 문제등록 기능구현  
&nbsp;&nbsp;&nbsp;3) 문제구성관리 파트 선택모의고사 및 전체 문제선택 확인 기능구현  

   **11. 사용자 로그인 파트 화면구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 사용자 로그인 파트 화면구현 및 기능구현  

   **12. 관리자 로그인 파트 화면구현 및 기능구현**  
&nbsp;&nbsp;&nbsp;1) 관리자 로그인 파트 화면구현 및 기능구현  
